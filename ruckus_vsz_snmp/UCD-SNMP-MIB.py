...
class UCDErrorFix(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(0, 1, )
	namedValues = NamedValues(("noError", 0), ("runFix", 1), )


class UCDErrorFlag(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(0, 1, )
	namedValues = NamedValues(("noError", 0), ("error", 1), )


class Float(Opaque):  # pylint:disable=too-few-public-methods
...
ucdStart = NotificationType((1, 3, 6, 1, 4, 1, 2021, 251, 1)).setObjects(*())  # pylint:disable=star-args
if mibBuilder.loadTexts:
	ucdStart.setDescription("This trap could in principle be sent when the agent start")
ucdShutdown = NotificationType((1, 3, 6, 1, 4, 1, 2021, 251, 2)).setObjects(*())  # pylint:disable=star-args
if mibBuilder.loadTexts:
