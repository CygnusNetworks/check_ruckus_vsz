...
if mibBuilder.loadTexts: ruckusSCGConfigWLANMIB.setContactInfo("Ruckus Wireless, Inc.\n\n350 West Java Dr.\nSunnyvale, CA 94089\nUSA\n\nT: +1 (650) 265-4200\nF: +1 (408) 738-2065\nEMail: info@ruckuswireless.com\nWeb: www.ruckuswireless.com")
if mibBuilder.loadTexts: ruckusSCGConfigWLANMIB.setDescription("Ruckus WLAN mib")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANTable.setDescription("SCG WLAN table.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANEntry.setDescription("Specifies each SCG WLAN configuration entry.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANID.setDescription("this Wireless LAN(WLAN) ID ")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANSSID.setDescription("SSID for this Wireless LAN.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANDescription.setDescription("Description for this Wireless LAN.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANName.setDescription("Name for this Wireless LAN")
...
if mibBuilder.loadTexts: ruckusSCGZoneName.setDescription("Zone name for this wlan")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANWLANServiceType.setDescription("The the Service type for the Wireless LAN.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANAuthentication.setDescription("Authentication method choosen for this Wireless LAN.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANEncryption.setDescription("Encryption method choosen for this Wireless LAN.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANWEPKeyIndex.setDescription("Select the WEP key index for the WEP encryption.\nfor 802.1x wlan(eap), this node should not be set.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANWEPKey.setDescription("Enter the Pass-phrase for the WEP encryption method.\nOnly 10 or 26 Hex character.such as: 1122334455.\nfor 802.1x wlan(eap), this node should not be set.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANWPACipherType.setDescription("Enter the encryption cipher method for the WPA encryption.\nfpr WPA2,aes is only supported.null is only for read.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANWirelessClientIsolation.setDescription("set Wireless Client Isolation, clients will be unable to communicate with each other, or access any of the restricted subnet.\nfor Guest and webauth WLAN type, it must be 'enable'.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANZeroITActivation.setDescription("Enable the Zero IT Activation Service of the Wireless LAN or not.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANServicePriority.setDescription("Select the QOS service priority for the Wireless LAN.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANAccountingUpdateInterval.setDescription("Enter interval in minutes to update Accounting Server.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANVlanID.setDescription("Specifies the VLAN ID of the WLAN.  If VLAN ID is 1, packets from this WLAN will be untagged.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANHideSSID.setDescription("Hide SSID, not to broadcast it SSID.")
...
if mibBuilder.loadTexts: ruckusSCGConfigWLANMaxClientsPerAP.setDescription("Select the Number of client devices the AP can service for the Wireless LAN.")
