...
class RuckusAAAServiceType(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusAPApproveMode(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(2, 1, )
	namedValues = NamedValues(("approved", 1), ("not-approved", 2), )


class RuckusAPIpAddressSettingMode(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusAPMeshConfigurationMode(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusAPRadioTxPowerLevel(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusAPRadioType(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusAPRadioType24(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusAPRadioType5(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusAPUplinkSelectionMode(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(2, 1, )
	namedValues = NamedValues(("smart", 1), ("manual", 2), )


class RuckusAPWirelessChannel(Integer32):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer32.subtypeSpec + ValueRangeConstraint(0, 11)


class RuckusAdminStatus(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(1, 2, )
	namedValues = NamedValues(("enable", 1), ("disable", 2), )


class RuckusAuthenticationType(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusCountryCode(OctetString):  # pylint:disable=too-few-public-methods
	subtypeSpec = OctetString.subtypeSpec + ValueSizeConstraint(2, 2)
	fixedLength = 2


class RuckusEncryptionType(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusFequency(Integer32):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer32.subtypeSpec + ValueRangeConstraint(2412, 5805)


class RuckusNameString(OctetString):  # pylint:disable=too-few-public-methods
	subtypeSpec = OctetString.subtypeSpec + ValueSizeConstraint(1, 128)


class RuckusPassPhrase(OctetString):  # pylint:disable=too-few-public-methods
	subtypeSpec = OctetString.subtypeSpec + ValueSizeConstraint(8, 64)


class RuckusRadioMode(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusRate(OctetString):  # pylint:disable=too-few-public-methods
	subtypeSpec = OctetString.subtypeSpec + ValueSizeConstraint(1, 126)


class RuckusRateLimiting(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusSNMPVersionType(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(1, 2, )
	namedValues = NamedValues(("v2", 1), ("v3", 2), )


class RuckusSNMPv3AuthenticationType(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(2, 1, )
	namedValues = NamedValues(("md5", 1), ("sha", 2), )


class RuckusSNMPv3EncryptionType(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(2, 1, )
	namedValues = NamedValues(("des", 1), ("aes", 2), )


class RuckusSSID(OctetString):  # pylint:disable=too-few-public-methods
	subtypeSpec = OctetString.subtypeSpec + ValueSizeConstraint(2, 32)


class RuckusSysLogLevel(Integer):  # pylint:disable=too-few-public-methods
...
class RuckusWEPKey(OctetString):  # pylint:disable=too-few-public-methods
	subtypeSpec = OctetString.subtypeSpec + ConstraintsUnion(ValueSizeConstraint(5, 5), ValueSizeConstraint(26, 26))


class RuckusWLANServicePriority(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(1, 2, )
	namedValues = NamedValues(("high", 1), ("low", 2), )


class RuckusWLANServiceType(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(3, 2, 1, )
	namedValues = NamedValues(("standardUsage", 1), ("guestAccess", 2), ("hotSpotService", 3), )


class RuckusWPACipherType(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(2, 3, 4, 1, )
	namedValues = NamedValues(("tkip", 1), ("aes", 2), ("auto", 3), ("none", 4), )


class RuckusWPAPassPhrase(OctetString):  # pylint:disable=too-few-public-methods
	subtypeSpec = OctetString.subtypeSpec + ValueSizeConstraint(8, 64)


class RuckusZDAPManagementAdminControl(Integer):  # pylint:disable=too-few-public-methods
	subtypeSpec = Integer.subtypeSpec + SingleValueConstraint(1, 2, )
	namedValues = NamedValues(("delete", 1), ("associated", 2), )


class RuckusdB(Integer32):  # pylint:disable=too-few-public-methods
	pass
...
if mibBuilder.loadTexts:
	ruckusTCMIB.setOrganization("Ruckus Wireless, Inc.")
if mibBuilder.loadTexts:
	ruckusTCMIB.setContactInfo("Ruckus Wireless, Inc.\n\n350 West Java Dr.\nSunnyvale, CA 94089\nUSA\n\nT: +1 (650) 265-4200\nF: +1 (408) 738-2065\nEMail: info@ruckuswireless.com\nWeb: www.ruckuswireless.com")
if mibBuilder.loadTexts:
	ruckusTCMIB.setDescription("This is the mib module for defining all the textual\nconventions.")
