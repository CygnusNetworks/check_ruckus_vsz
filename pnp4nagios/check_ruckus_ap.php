...
$ds_name[1] = 'Clients';
$opt[1] = "--lower-limit 0 --vertical-label \"Clients\"  --title $hostname";
$def[1] .= rrd::line1("num_sta", "#21db2a", "Clients");
$def[1] .= rrd::gprint("num_sta", array("LAST", "AVERAGE", "MAX"), "Average %3.0lf");

$ds_name[2] = 'Throughput';
$opt[2] = "--lower-limit 0 --vertical-label \"Bytes\"  --title $hostname";
